...
Frontend stories are NOT complete until visually verified. Ralph will use available browser automation tools to navigate to the page, interact with the UI, and confirm changes work.
